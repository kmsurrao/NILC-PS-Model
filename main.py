...
def get_data_vectors(inp, env):
    ...
    # CMB_NILC_map = 10**(-6)*hp.read_map(f'{inp.output_dir}/pyilc_outputs/needletILCmap_component_CMB.fits')
    # tSZ_NILC_map = hp.read_map(f'{inp.output_dir}/pyilc_outputs/needletILCmap_component_tSZ.fits')

    #get directly computed Clpq of NILC maps
    CMB_NILC_map, tSZ_NILC_map = build_NILC_maps(inp, h, CMB_wt_maps, tSZ_wt_maps)
    ...
    CMB_prop_to_CMB_NILC_map, CMB_prop_to_tSZ_NILC_map = build_NILC_maps(inp, h, CMB_wt_maps, tSZ_wt_maps, [CMB_map, CMB_map])
    tSZ_prop_to_CMB_NILC_map, tSZ_prop_to_tSZ_NILC_map = build_NILC_maps(inp, h, CMB_wt_maps, tSZ_wt_maps, [g_tsz[0]*tSZ_map, g_tsz[1]*tSZ_map])
    ...
    pickle.dump(directly_computed_prop_to_NILC_PS, open(f'{inp.output_dir}/data_vecs/directly_computed_prop_to_NILC_PS.p', 'wb'), protocol=4)
